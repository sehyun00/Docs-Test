...
|---|-------|------|---------|---------|----------|
| 0 | [앱 소개 온보딩](./00_onboarding.md) | `00_onboarding.md` | P1 | 🆕 작성완료 | ❌ 미구현 |
...
| 7 | [설정](./07_settings.md) | `07_settings.md` | P2 | ✅ 분석완료 | ✅ **구현완료** |
| 8 | [종목 상세](./08_stock_detail.md) | `08_stock_detail.md` | P1 | 🆕 작성완료 | ❌ 미구현 |
| 9 | [앱 튜토리얼](./09_tutorial.md) | `09_tutorial.md` | P2 | 🆕 작성완료 | ❌ 미구현 |

> **Prototype V3 구현 현황**: 7/10 화면 완료 (2026-01-09 기준)
